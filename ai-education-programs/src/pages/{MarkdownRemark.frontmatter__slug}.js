...
export default function Template({
  ...
  return (
    <div>
      ...
      <div style={{margin: "auto", maxWidth: "1200px", marginTop: "50px"}}>
              ...
              <Table aria-label="simple table" size={"small"} style={{marginBottom: 0}}>
                <TableBody>
                  <TableRow style={{verticalAlign: "middle"}}>
                    <TableCell><img src={claire} style={{margin: "5px 0px 0px 10px", borderRadius: "10px"}}/></TableCell>
                  ...
                  <TableRow style={{verticalAlign: "middle"}}>
                    <TableCell><img src={kayla} style={{margin: "5px 0px 0px 10px", borderRadius: "10px"}}/></TableCell>
